...
description: |
  Given a graph, this article will cover the critiques concerning said graphs, plans on how to improve visualization, and steps to create the sketched improvement using Tableau Desktop.
author:
